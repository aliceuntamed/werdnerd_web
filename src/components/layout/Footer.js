...
export function Footer() {
    return (<footer className="w-full bg-bg-elevated border-t border-border-subtle mt-20 pt-12 pb-10 px-6 text-text-primary font-body">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-16">
          ...
          <div className="max-w-sm flex flex-col gap-4">
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-4">
                {["Instagram", "Twitter", "LinkedIn", "Facebook"].map((label) => (<button key={label} aria-label={`Follow us on ${label}`} className="w-10 h-10 flex items-center justify-center rounded-full border border-border-subtle hover:border-accent-pink transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2 text-sm text-text-muted">
                <Link to="/submit-werd" className="hover:text-text-primary transition-colors">
                  Submit a werd
                </Link>
                <a className="hover:text-text-primary transition-colors">
                  Nerd Forum
