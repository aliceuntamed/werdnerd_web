...
export const ChromeSky = ({ density = "medium", className = "", }) => {
    ...
    const generateStars = (count) => Array.from({ length: count }).map(() => {
        ...
        const color = chromeColors[Math.floor(Math.random() * chromeColors.length)];
    ...
    return (<div className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0 animate-[skyMove_120s_linear_infinite]" style={{
            background: "transparent",
            boxShadow: stars1,
        }}/>

      <div className="absolute inset-0 animate-[skyMove_180s_linear_infinite]" style={{
            background: "transparent",
            boxShadow: stars2,
        }}/>

      <div className="absolute inset-0 animate-[skyMove_240s_linear_infinite]" style={{
            background: "transparent",
            boxShadow: stars3,
        }}/>
