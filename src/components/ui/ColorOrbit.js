...
export const ColorOrbit = ({ size = 100, height = 150, speed = 20, colors = [
    ...
    return (<div className={`relative flex items-center justify-center overflow-hidden ${className}`}>
      <div className="absolute top-1/4 left-1/2" style={{
        ...
        {colors.map((rgb, index) => (<div key={index} className="absolute inset-0 rounded-xl border-2 overflow-hidden" style={{
