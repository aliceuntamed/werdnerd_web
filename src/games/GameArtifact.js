...
export function GameArtifact({ game }) {
    const navigate = useNavigate();
    const getGamePath = (gameType) => {
        const paths = {
            boggle: "/games/boggle",
            wordle: "/games/wordle",
            trivia: "/games/trivia",
    ...
    const renderGameContent = (gameType) => {
        switch (gameType) {
            case "boggle":
                return (<div className="grid grid-cols-2 gap-2">
            {[..."BOGL"].map((letter, i) => (<div key={i} className="
            ...
            {letters.map((letter, i) => (<div key={i} className={`
            ...
            case "hangman":
              ...
              shadow-[inset_0_2px_3px_rgba(255,255,255,0.25),_0_10px_20px_rgba(0,0,0,0.7)]
            ">
            <svg width="70" height="110" viewBox="0 0 70 110" fill="none" xmlns="http://www.w3.org/2000/svg" className="stroke-white/70" strokeWidth="6" strokeLinecap="round">
            ...
            <div className="grid grid-cols-4 gap-2">
              {grid.flat().map((letter, i) => (<div key={i} className={`
            ...
            case "codenames":
                return (<div className="relative w-40 h-28 mx-auto">
            <div className="
                absolute top-4 left-4
    ...
    return (<div onClick={() => navigate(getGamePath(game))} className={`
