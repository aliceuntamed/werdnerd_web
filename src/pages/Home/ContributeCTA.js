    ...
    return (<div className="max-w-3xl mx-auto text-center">
      <div className="relative rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-md p-10 md:p-16 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <Link to="/submit-werd" className="inline-flex items-center gap-2 px-8 py-4 rounded-lg font-heading text-base text-black bg-chrome-horizontal shadow-lg hover:opacity-90 active:scale-95 transition-all">
