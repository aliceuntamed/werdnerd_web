...
export default function Hero() {
    return (<div className="relative w-full h-screen flex flex-col items-center justify-center text-center px-6">
      ...
      <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-8">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl tracking-tight leading-[1.05]" style={{
          ...
          <span className="inline-flex items-baseline" style={{ color: "#9bbcff" }}>
            <Flipwords werds={["unusual", "curious", "obscure", "poetic", "intriguing"]} duration={3200} className="text-[#9bbcff]"/>
          </span>
          <br />
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 animate-bounce" style={{ color: "rgba(255,255,255,0.25)" }}>
